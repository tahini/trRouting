...
public:
    ...
    std::unique_ptr<TrRouting::RoutingResult> calculateWithAlternatives(std::vector<std::string> parameters);
};
...
TEST_F(TAndACalculationFixtureTests, TripWithAlternatives)
{
    ...
    std::unique_ptr<TrRouting::RoutingResult> result = calculateWithAlternatives(parametersWithValues);
...
std::unique_ptr<TrRouting::RoutingResult> TAndACalculationFixtureTests::calculateWithAlternatives(std::vector<std::string> parameters)
{
